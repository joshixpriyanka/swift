...
var blackmithShop: [String: Int] = ["Bottle": 10, "Shield": 15, "Ocarina": 1000]

// Accessing and modifying values
var shieldPrice = blackmithShop["Shield"]
blackmithShop["Bottle"] = 11

blackmithShop["Towel"] = 1
print(blackmithShop)

// All keys and values
let allKeys = [String](blackmithShop.keys)
let allValues = [Int](blackmithShop.values)
