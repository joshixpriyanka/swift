...
var shopItemDictonary = ["Stone Shield": 15, "Bronze Hammer": 25, "Gold Helm": 35, "Diamond Longsword": 100]


// 2
var longswordInstock = shopItemArray.contains("Diamond Longsword")

// 3
shopItemArray.insert("Diamond Longsword", at: 3)

// 4
var selectedItem = shopItemArray[2]

// 5
var selectedItemPrice = shopItemDictonary[selectedItem]
