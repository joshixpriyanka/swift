 ...
 */
// 1
var leftthandWeapon: String? = "Giant is Hammer"
var rightthandWeapon: String?

// 2
if let leftWeapon = leftthandWeapon, let rightWeapon = rightthandWeapon {
    print("Looks like your \(leftWeapon) and \(rightWeapon) are an even match for me!")
}else{
    print("I did not bring enough hardwork for this...")
}
